                    ...
                    >
                        ...
                        >
                            <view class="menu-list">
                                <view
                                    class="menu-item"
                                    :class="{ active: selected.gradeid === 0 }"
                                ...
                                <view
                                    ...
                                    class="menu-item"
                                    :class="{
                                        active: selected.gradeid === item.id
                                    }"
                        ...
                        >
                            <view class="menu-list">
                                <view
                                    ...
                                    :class="{
                                        active:
                                            filter.cat_id.three_level_id === 0
                                    }"
    ...
    methods: {
        onSelect(type, value) {
            switch (type) {
                // 选择市
                case 'city':
                    this.selected.cityid = value;
                    this.selected.countyid = 0;
                ...
                // 选择区
                case 'county':
                    this.selected.countyid = value;
                    this.filter.address.county_id = value;
                    break;
                case 'grade':
                    this.selected.gradeid = value;
        ...
        getData() {
            api.get('/api/works/cats').then((res) => {
                console.log(res);
                console.log(this.filter.cat_id);
