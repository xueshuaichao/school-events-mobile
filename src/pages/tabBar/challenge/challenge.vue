<template>
    <view class="page-index">
        ...
        <view class="menu-list">
            <navigator
                class="item"
                :url="`/pages/address/index?id=2&title=兑换确认`"
            >
            ...
            <navigator
                class="item"
                :url="
                    `/pages/address/address?id=${menuConf.notice.id}&title=收货地址`
                "
            >
            ...
            <navigator
                class="item"
                :url="
                    `/pages/address/exchangeRecord?id=${menuConf.notice.id}&title=兑换记录`
                "
            >
