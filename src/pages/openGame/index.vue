            ...
            >
                <view class="active-content">
                    ...
                    <view class="title-icon">
                        ...
                        <view>
                            网络预选赛阶段，挑战类各项目和吉尼斯项目纪录排名前2位直接晋级省级总决赛，各项目排名前5位授予省级“技能达人”。才艺秀各项目根据点赞量排名，
                            前10位直接晋级省级总决赛，前50位授予省级“人气之星”。除直接晋级省级总决赛的选手外，其余各级直播赛晋级名额通过网络直播赛逐级推选产生
                        </view>
                    </view>
                </view>
            </view>
